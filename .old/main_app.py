...
with gr.Blocks() as demo:
    ...
    with gr.Tab("2. Separate Speech"):
        ...
        with gr.Row():
            ...
            non_speach_silence_step3 = gr.Checkbox(label="Save silence only in backround file", value=False)
        ...
        separate_button.click(
            separate_audio,
            inputs=[project_dropdown, device_step3, keep_full_audio_step3, non_speach_silence_step3, demucs_model_selection],
            outputs=output3
        )
