...
# logger.info(f"Project root determined as: {PROJECT_ROOT}") # Eltávolítva, hogy ne ismétlődjön minden workerben
...
def main_worker(gpu, args, all_chunks, input_wav_path_str):
    # JAVÍTÁS: A worker a saját GPU azonosítója alapján kiválasztja a neki szánt feladatcsomagot
