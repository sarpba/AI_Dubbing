# FILE: f5_tts_easy9_kisérleti_old.py
...
def main_worker(gpu, args, all_chunks, input_wav_path_str, stats, failed_segments_info):
    ...
    try:
        ...
        for segment in tqdm.tqdm(tasks_chunk, desc=f"Processing on {device}", position=gpu):
            ...
            ### MÓDOSÍTOTT: Referencia szöveg átalakítása ###
                ...
                for attempt in range(1, args.max_retries+1):
                    ...
                    try:
                        ...
                        with tempfile.NamedTemporaryFile(suffix=".wav",delete=True) as tmp_ref:
                            ...
                            ### MÓDOSÍTOTT: A (potenciálisan fonetikus) current_ref_text használata ###
                        ...
                        if dist <= final_tolerance:
                            ...
                            if args.save_failures:
                                ...
                                if attempt==1:
                                    ...
                                    # Módosított info mentés, hogy a fonetikus szöveg is bekerüljön, ha használtuk
                            ...
                            if args.double_ref_on_failure and attempt == 1:
                                ...
                                ### MÓDOSÍTOTT: A (potenciálisan fonetikus) current_ref_text duplázása ###
