# ==============================================================================
#           NVIDIA PARAKEET‑TDT TRANSCRIPTION SCRIPT  (FINAL, V3.9)
# ==============================================================================
...
def process_directory_final_v3(directory_path: str, auto_chunk: bool = True, fixed_chunk_s: int = DEFAULT_CHUNK_S):
    ...
    # BUGFIX 1: Initialize 'wavs' list unconditionally.
    ...
    for ap in wavs:
        ...
        # BUGFIX 2: Pass the 'device' argument to the transcription function.
        res = transcribe_long_audio_final(asr_model, ap, chunk_len_s=chunk_len_s, batch_size=8, device=device)
...
def main():
    p = argparse.ArgumentParser(description="Transcribe audio files with NVIDIA NeMo (word‑level timestamps, v3.9)")
    ...
    p.add_argument("--chunk", type=int, default=DEFAULT_CHUNK_S, help="Fix chunk‑hossz mp‑ben auto‑chunk nélkül.")
    args = p.parse_args()
