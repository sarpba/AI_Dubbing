...
if __name__ == "__main__":
    ...
    # ### VÁLTOZTATÁS KEZDETE ###
    # Könyvtárak elérési útvonalának összeállítása a config és a projekt neve alapján
    ...
    translated_json_dir = project_path / subdirs['translated'] # Új sor
